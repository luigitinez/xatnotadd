...
<head>
	...
	var ip_ad = <?php echo "'" . $_SERVER['REMOTE_ADDR'] . "'" ?>;	
	ip_ad = "188.85.113.132";
...
//esta verifica que se haya introducido un número y si es así llama a otra función en función de su parámetro
		...
		country_code = new Promise(function(done,fail){
			$.ajax({
			    type:"GET", 
			    url: "http://ip-api.com/json/" + ip_ad, 
...
<footer class="page-footer font-small blue ">
  ...
  <div class="footer-copyright text-center py-3">Your IP is:
    <a href=<?= 'https://ipinfo.io/'. $_SERVER['REMOTE_ADDR']; ?> > <?= $_SERVER['REMOTE_ADDR'];?></a>
  </div>
  <!-- Copyright -->
